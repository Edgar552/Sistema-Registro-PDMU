...
<h1>Sub Zonas / Unidades del P.D.M.U.</h1>

<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'cat-sub-zona-grid',
	...
	'summaryText'=>'{start}-{end} de {count} Sub Zonas / Unidades',// muestra el numero que tiene de datos parte superior derecha
