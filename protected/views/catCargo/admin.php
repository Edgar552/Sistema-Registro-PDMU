<h1>Cargos actuales del P.D.M.U</h1>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'summaryText'=>'{start}-{end} de {count} Cargos',// muestra el numero que tiene de datos parte superior derecha
