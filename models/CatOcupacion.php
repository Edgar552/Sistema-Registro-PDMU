...
/**
 * This is the model class for table "cat_ocupacion".
 *
 * The followings are the available columns in table 'cat_ocupacion':
 ...
 */
class CatOcupacion extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return CatOcupacion the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'regElementos' => array(self::HAS_MANY, 'RegElemento', 'id_ocupacion'),
		);
	}
