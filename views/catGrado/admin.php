<h1>Grados Actuales del P.D.M.U.</h1>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'summaryText'=>'{start}-{end} de {count} Grados',// muestra el numero que tiene de datos parte superior derecha
